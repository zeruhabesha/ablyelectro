...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2022 at 02:12 PM
...
(1, 'fgds', 'gads@gmail.com', 935964964, 'fsdafdfd', 'fsfsjvbuioshe');
...
INSERT INTO `products` (`id`, `category_id`, `subid`, `name`, `description`, `slug`, `price`, `photo`, `quantity`, `date_view`, `counter`, `location`) VALUES
(35, 0, 10, '1500 Series Wound Motor, Up to 80V', '<ul>\r\n	<li>Current 130 A</li>\r\n	<li>Voltage Up to 80V</li>\r\n	<li>Speed 1500</li>\r\n	<li>Frequency 50/60 HZ</li>\r\n</ul>\r\n', '1500-series-wound-motor-up-80v', 1200, '1500-series-wound-motor-up-80v.jpg', 89, '2022-08-18', 1, 'tgerwte'),
(36, 0, 11, '0.25 Kw Three Phase DC Series Motor, Voltage: 320 V, 1440 Rpm', '<ul>\r\n	<li><strong>Speed </strong>1440 RPM</li>\r\n	<li><strong>Power </strong>0.25 kW</li>\r\n	<li><strong>Voltage </strong>320 V</li>\r\n</ul>\r\n', '0-25-kw-three-phase-dc-series-motor-voltage-320-v-1440-rpm', 2000, '0-25-kw-three-phase-dc-series-motor-voltage-320-v-1440-rpm.jpg', 45, '2022-07-30', 1, 'Addis Ababa'),
(37, 0, 11, '28BYJ-48 5V Mini Stepper Motor', '<ul>\r\n	<li>Rated voltage supply +5V</li>\r\n	<li>No of phase 4</li>\r\n	<li>Stride angle <em>5.625&deg;/64</em></li>\r\n	<li>Speed variation <em>ratio 1/64</em></li>\r\n	<li>Pull-in torque <em>300 gf.cm</em></li>\r\n	<li>Friction torque <em>600-1200 gf.cm</em></li>\r\n</ul>\r\n', '28byj-48-5v-mini-stepper-motor', 9000, '28byj-48-5v-mini-stepper-motor.jpg', 122, '2022-07-22', 1, 'Addis Ababa'),
(38, 11, 19, '50 W Electric PMDC Motor, 220-440 V', '<ul>\r\n	<li>Power Source Electric</li>\r\n	<li>Speed (RPM) 5 to 10,000 RPM</li>\r\n	<li>Voltage 220-440 V</li>\r\n	<li>Power 50 W</li>\r\n</ul>\r\n', '50-w-electric-pmdc-motor-220-440-v', 3400, '50-w-electric-pmdc-motor-220-440-v.png', 15, '2022-08-18', 2, 'Bahirdar'),
(39, 0, 15, 'process control trainer', '<p>The PCT-100, Process Control Trainer, is a fully integrated, self-contained bench top apparatus consisting of a Process Module, and a Control Console with a built in power supply.</p>\r\n', 'process-control-trainer', 3000, 'process-control-trainer.png', 200, '2022-07-30', 3, 'Adama'),
(40, 12, 24, 'M7 Diode', '<ul>\r\n	<li>Voltage 1000V</li>\r\n	<li>Current 1.0A</li>\r\n	<li>Maximum DC Blocking Voltage 50VDC</li>\r\n	<li>Maximum Repetitive Peak Reverse Voltage</li>\r\n</ul>\r\n', 'm7-diode', 400, 'm7-diode.jpg', 0, '2022-07-30', 3, 'Hawasa'),
(41, 0, 12, 'Silicon NPN Phototransistor, RoHS Compliant', '<p>BPW77 is a silicon NPN phototransistor with high radiant<br />\r\nsensitivity in hermetically sealed TO-18 package with base<br />\r\nterminal and glass lens. It is sensitive to visible</p>\r\n', 'silicon-npn-phototransistor-rohs-compliant', 5000, 'silicon-npn-phototransistor-rohs-compliant.jpg', 15, '2022-07-30', 2, 'Adama'),
(44, 13, 21, 'ewreq', '<p>tdsfdg</p>\r\n', 'ewreq', 4532, 'ewreq.png', 0, '2022-07-30', 2, 'rewr'),
(46, 0, 15, 'yuiryi', '<p>kjhgk</p>\r\n', 'yuiryi', 749.99, 'yuiryi.PNG', 78, '0000-00-00', 0, 'wwww'),
(47, 16, 28, 'gdsffgg', '<p>yrfthbgf</p>\r\n', 'gdsffgg', 777, 'gdsffgg.PNG', 686, '0000-00-00', 0, 'dsfgfd'),
(48, 0, 14, 'gjklj', '<p>iytiuy</p>\r\n\r\n<p>&nbsp;</p>\r\n', 'gjklj', 9769, 'gjklj.jpg', 765, '0000-00-00', 0, 'iyuiut'),
(49, 0, 12, 'uyriu', '<p>jhgk</p>\r\n', 'uyriu', 98, 'uyriu.jpg', 999, '0000-00-00', 0, 'iouoy'),
(50, 16, 28, 'jjjjjjjjjjj', '<p>iuuu</p>\r\n', 'jjjjjjjjjjj', 9769, 'jjjjjjjjjjj.PNG', 56, '0000-00-00', 0, 'iytiuy');
